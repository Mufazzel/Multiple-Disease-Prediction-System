...
Repository: https://github.com/Mufazzel/Multiple-Disease-Prediction-System
"""
...
if selected == 'Diabetes Prediction':
    ...
    # Getting input data from user in 3 columns
        ...
        try:
            ...
            if hasattr(diabetes_model, 'predict') and callable(getattr(diabetes_model, 'predict')):
                ...
                if isinstance(res, dict):
                    ...
                    # Standard scikit-learn model list prediction
                ...
                diab_diagnosis = 'Model loaded successfully'
                is_diabetic = False
                prob = 0
