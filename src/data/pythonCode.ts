export const PYTHON_APP_CODE = `import pickle
...
export const REQUIREMENTS_TXT = `streamlit>=1.22.0
...
export const TRAINING_CODE_SNIPPET = `# Example: Training Diabetes Support Vector Machine (SVM) Classifier
import numpy as np
import pandas as pd
