"""
Diabetes Diagnostic Module (Streamlit & Python Engine)
"""
import streamlit as st
from python.diabetes_model import DiabetesModel
from src.presets import DIABETES_PRESETS

def render_diabetes_view(model: DiabetesModel):
        ...
        if res["hasDisease"]:
            st.markdown(f"""
                <div class="result-card-positive">
                    <h3 style="color:#b91c1c; margin:0 0 0.5rem 0;">⚠️ Diagnostic Outcome: Positive (Diabetic Indicator)</h3>
            ...
            st.markdown(f"""
                <div class="result-card-negative">
                    <h3 style="color:#15803d; margin:0 0 0.5rem 0;">✅ Diagnostic Outcome: Negative (Non-Diabetic)</h3>
