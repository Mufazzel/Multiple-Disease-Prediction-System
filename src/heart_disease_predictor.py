"""
Heart Disease Diagnostic Module (Streamlit & Python Engine)
"""
import streamlit as st
from python.heart_disease_model import HeartDiseaseModel
from src.presets import HEART_PRESETS

def render_heart_view(model: HeartDiseaseModel):
        ...
        if res["hasDisease"]:
            st.markdown(f"""
                <div class="result-card-positive">
                    <h3 style="color:#b91c1c; margin:0 0 0.5rem 0;">⚠️ Diagnostic Outcome: Heart Disease Detected</h3>
            ...
            st.markdown(f"""
                <div class="result-card-negative">
                    <h3 style="color:#15803d; margin:0 0 0.5rem 0;">✅ Diagnostic Outcome: Healthy Cardiovascular Profile</h3>
