"""
Parkinson's Disease Diagnostic Module (Streamlit & Python Engine)
"""
import streamlit as st
from python.parkinsons_model import ParkinsonsModel
from src.presets import PARKINSONS_PRESETS

def render_parkinsons_view(model: ParkinsonsModel):
    ...
    if st.button("🔍 Execute Parkinson's Acoustic Assessment"):
        ...
        if res["hasDisease"]:
            st.markdown(f"""
                <div class="result-card-positive">
                    <h3 style="color:#b91c1c; margin:0 0 0.5rem 0;">⚠️ Diagnostic Outcome: Parkinson's Acoustic Dysphonia Detected</h3>
            ...
            st.markdown(f"""
                <div class="result-card-negative">
                    <h3 style="color:#15803d; margin:0 0 0.5rem 0;">✅ Diagnostic Outcome: Normal Vocal Pattern (Negative)</h3>
        ...
        for factor in res["contributingFactors"]:
